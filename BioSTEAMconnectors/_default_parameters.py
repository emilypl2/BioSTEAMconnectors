...
default_parameters = [
    ...
    Variable('Gasoline_LHV', 112193.52, 'Btu/gal'),
    ...
    Variable('Electricity_LHV', 3412.1416416, 'Btu/kWh'),
...
default_parameters.extend([
    ...
    # For fuels, applicable for all crops in the US despite starting with "Corn"
    # Diesel (US)
    ...
    Variable('Herbicide_SugarcaneFarming_CO2', 14.6740189992022, 'g CO2/ton',
             notes='Only used for Brazil, unless assume to be the same as corn.'),
    Variable('Herbicide_SugarcaneFarming_GHG', 15.5005618973604, 'g CO2/ton',
             notes='Only used for Brazil, unless assume to be the same as corn.'),
    Variable('Herbicide_RiceFarming_CO2', 17.8510998760147, 'g CO2/ton',
             notes='Assume the same as corn due to lack of data.'),
    Variable('Herbicide_RiceFarming_GHG', 18.875995540809, 'g CO2/ton',
             notes='Assume the same as corn due to lack of data.'),
    # Insecticide
    Variable('Insecticide_CornFarming_CO2', 20.48274601, 'g CO2/ton'),
    Variable('Insecticide_CornFarming_GHG', 21.68174043, 'g CO2/ton'),
    Variable('Insecticide_SoybeanFarming_CO2', 20.48274601, 'g CO2/ton'),
    Variable('Insecticide_SoybeanFarming_GHG', 21.68174043, 'g CO2/ton'),
    Variable('Insecticide_GSFarming_CO2', 20.48274601, 'g CO2/ton'),
    Variable('Insecticide_GSFarming_GHG', 21.68174043, 'g CO2/ton'),
    Variable('Insecticide_SugarcaneFarming_CO2', 16.64520918, 'g CO2/ton',
             notes='Only used for Brazil, unless assume to be the same as corn.'),
    Variable('Insecticide_SugarcaneFarming_GHG', 17.60437507, 'g CO2/ton',
             notes='Only used for Brazil, unless assume to be the same as corn.'),
    Variable('Insecticide_RiceFarming_CO2', 20.48274601, 'g CO2/ton',
             notes='Assume the same as corn due to lack of data.'),
    Variable('Insecticide_RiceFarming_GHG', 21.68174043, 'g CO2/ton',
             notes='Assume the same as corn due to lack of data.'),
    # Brazilian Phosphate (P2O5)
